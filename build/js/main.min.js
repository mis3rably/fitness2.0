...
var initiallyActiveButton = tabsButtonList.querySelector('.subscription__button--active');
...
var handleTabButtonClick = function handleTabButtonClick(clickedButton) {
  var tabsType = clickedButton.dataset.tabGroupButton;
...
if (tabsButtonList && tabIndicatorFill) {
  ...
  tabsButtonList.addEventListener('click', function (evt) {
    if (evt.target.classList.contains('subscription__button') && !evt.target.classList.contains('subscription__button--active')) {
      var tabId = evt.target.dataset.tabButton;
